...
To respond to our second question we used a correlation plot.
...
2.  Convert variables to numeric factors

3. Call GGally from library

4. Create a base correlation plot from the dataframe define in Step 1

5. Add titles and captions

6. Edit the location and size of text elements
