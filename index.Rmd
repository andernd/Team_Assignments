...
##### Explanation 
To create a heatmap plot using the following steps:
1. Load the data
2. Call 'scales' from the library
3. Create a new dataframe from the existing data to assist with heatmap plotting
